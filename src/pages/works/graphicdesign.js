...
export const pageQuery = graphql`
  query GraphicdesignQuery {
    ...
    image1: file(relativePath: { eq: "graphicDesign/gr_design_1.jpg" }) {
      childImageSharp {
        sizes(quality: 100) {
    ...
    image2: file(relativePath: { eq: "graphicDesign/gr_design_2.jpg" }) {
      childImageSharp {
        sizes(quality: 100) {
          ...GatsbyImageSharpSizes_withWebp
        }
    ...
    image3: file(relativePath: { eq: "graphicDesign/gr_design_3.jpg" }) {
      childImageSharp {
        sizes(quality: 100) {
          ...GatsbyImageSharpSizes_withWebp
        }
